...
public class ClienteForm extends javax.swing.JFrame {
    ...
    private SocketControladorCliente controladorCliente=new SocketControladorCliente("localhost",6666);
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       CuerpoRQ cuerpoRQ=new CuerpoRQ() 
       {

           @Override
           public void ejecutar() 
           {
               agregarAtributo(new Text(jTextField1.getText(),10));
               agregarAtributo(new Text(jTextField2.getText(),10));
               agregarAtributo(new Text(jTextField3.getText(),10));
           }
       ...
       mensajeRQ.setCuerpo(cuerpoRQ);
       //Mensaje rsp=controladorCliente.enviarMensaje(mensajeRQ);
